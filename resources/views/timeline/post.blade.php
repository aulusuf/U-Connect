...
<div class="status-card bg-white rounded px-3 border-b-2 border-gray-500 mb-3">
        <div class="postcard-head flex mb-2">
            ...
            <div class="flex-1 mt-3">
                ...
                <div class="font-hairline text-xs">{{ $simpanbeda[$loop->index] }}</div> {{-- $loop->index menghasilkan index dari perulangan --}}
            </div>
        ...
        <div class="flex text-gray-400">
            <button name="like_post" class="mr-2" type="submit">
        ...
        {{-- @foreach ($comments->comment_to_post) --}}
